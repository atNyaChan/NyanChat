...
Build the app yourself. See [BuildArchLinuxZh.md](docs/BuildArchLinuxZh.md) for one tested build setup.

See [NyanwChanges.md](docs/NyanwChanges.md) for changes made in this fork.
