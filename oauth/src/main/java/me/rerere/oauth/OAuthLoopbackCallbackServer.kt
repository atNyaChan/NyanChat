...
class OAuthLoopbackCallbackServer(
    ...
    private fun successHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "You can close this tab and return to NyanChat.",
        ),
    )
    ...
    private fun errorHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "Close this tab and try again from NyanChat.",
        ),
    )
    ...
    private fun invalidCallbackHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "Return to NyanChat and start the authorization again.",
        ),
    )
    ...
    private fun callbackAlreadyHandledHtml() = callbackPage(
        ...
        hint = localizedString(
            ...
            "You can safely close this tab and return to NyanChat.",
        ),
    )
    ...
    private fun callbackPage(
        ...
        return """
            ...
            <head>
              ...
              <title>$safeTitle · NyanChat</title>
              <style>
                :root {
