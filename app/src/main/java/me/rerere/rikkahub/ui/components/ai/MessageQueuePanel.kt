...
internal fun MessageQueuePanel(
    ...
    editing?.let { message ->
        ...
        val documents = input.messageContent.filterIsInstance<UIMessagePart.Document>()
        ...
        AlertDialog(
            ...
            text = {
                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    if (input.messageContent.isNotEmpty()) MediaFileInputRow(input, documentWordCounts)
                    OutlinedTextField(
            ...
            dismissButton = {
                TextButton(onClick = { editing = null }) { Text(stringResource(R.string.common_cancel)) }
            },
        )
    }
}
