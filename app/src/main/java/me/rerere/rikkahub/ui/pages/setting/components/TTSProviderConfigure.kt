...
private fun StepTTSConfiguration(
    ...
    FormItem(
        label = { Text(stringResource(R.string.setting_tts_page_api_key)) },
        description = { Text(stringResource(R.string.setting_tts_page_step_api_key_desc)) }
    ) {
        OutlinedTextField(
            value = setting.apiKey,
            onValueChange = { newApiKey ->
            ...
            modifier = Modifier.fillMaxWidth(),
            placeholder = { Text(stringResource(R.string.setting_tts_page_step_api_key_placeholder)) },
        )
    }
    ...
    val voices = listOf(
        "elegantgentle-female", "livelybreezy-female", "energeticconfident-female",
        "jingdiannvsheng", "wenroushunv", "tianmeinvsheng", "qingchunshaonv",
        "wenrounvsheng", "ruanmengnvsheng", "youyanvsheng", "lengyanyujie",
        "shuangkuaijiejie", "wenjingxuejie", "linjiajiejie", "linjiameimei",
        "zhixingjiejie", "cixingnansheng", "wenrounansheng", "yuanqinansheng",
        "zhengpaiqingnian", "ruyananshi", "boyinnansheng", "shenchennanyin",
        "shuangkuainansheng", "ganliannvsheng", "qinhenvsheng", "huolinvsheng",
        "jilingshaonv", "yuanqishaonv", "wenrougongzi", "qingniandaxuesheng",
    )
    ...
    FormItem(
        ...
        description = { Text(stringResource(R.string.setting_tts_page_response_format_desc)) }
    ) {
        SelectTextField(
    ...
    FormItem(
        label = { Text(stringResource(R.string.setting_tts_page_speed)) },
        description = { Text(stringResource(R.string.setting_tts_page_step_speed_desc)) }
    ) {
        OutlinedNumberInput(
            value = setting.speed,
            onValueChange = { newSpeed ->
    ...
    FormItem(
        ...
        description = { Text(stringResource(R.string.setting_tts_page_volume_desc)) }
    ) {
        OutlinedNumberInput(
    ...
    FormItem(
        ...
        description = { Text(stringResource(R.string.setting_tts_page_sample_rate_desc)) }
    ) {
        SelectTextField(
            value = setting.sampleRate.toString(),
            options = sampleRates,
    ...
    FormItem(
        ...
        description = { Text(stringResource(R.string.setting_tts_page_instruction_desc)) }
    ) {
        OutlinedTextField(
