...
class SettingsStore(
    ...
    val settingsFlowRaw = dataStore.data
        .catch { exception ->
            ...
            Settings(
                ...
                assistants = preferences[ASSISTANTS]?.let {
                    JsonInstant.decodeFromString(it)
                } ?: DEFAULT_ASSISTANTS,
                ...
                workspaceOrder = preferences[WORKSPACE_ORDER]?.let {
                    JsonInstant.decodeFromString(it)
                } ?: emptyList(),
    ...
    suspend fun update(settings: Settings) {
        ...
        dataStore.edit { preferences ->
            ...
            preferences[WORKSPACE_ORDER] = JsonInstant.encodeToString(settings.workspaceOrder)
...
data class Settings(
    ...
    val fastModelReasoningLevel: ReasoningLevel = ReasoningLevel.OFF,
...
data class DisplaySetting(
    ...
    val collapseChatInputToolbarWhenKeyboardVisible: Boolean = false,
