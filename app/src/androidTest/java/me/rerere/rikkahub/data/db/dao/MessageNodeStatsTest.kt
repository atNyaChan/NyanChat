...
class MessageNodeStatsTest {
    ...
    fun malformedRowsAreSkippedWhileValidMessagesAreAggregated() = runBlocking {
        ...
        assertEquals(
            mapOf("2026-08-12" to 2, "2026-08-13" to 1, "2026-08-01" to 1),
            dao.getMessageCountPerDay().associate { it.day to it.count },
        )
    ...
    fun onlyMalformedOrEmptyRowsProduceEmptyStats() = runBlocking {
        ...
        assertEquals(emptyList<MessageDayCount>(), dao.getMessageCountPerDay())
    }
