...
- Compose 页面、组件、设置表单、列表、弹窗、导航或 UI/UX review 必须先使用仓库内 `review-nyanchat-ui` skill；再按任务路由到 state/effects、component design、Navigation 3、adaptive、edge-to-edge、UI testing 或性能专项 skill。性能优化必须先有 compiler report、trace、benchmark 或明确复现证据。
